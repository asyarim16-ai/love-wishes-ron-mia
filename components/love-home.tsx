    ...
    <div className="min-h-screen gradient-hero-vibrant pattern-grid">
      ...
      <footer className="w-full text-center py-8 px-4">
        <p className="text-pink-600/60 text-sm">
          Этот сайт создан специально для тебя, чтобы ты чувствовал себя особенным. Здесь живут мои самые тёплые слова, маленькое волшебство и много-много любви. Надеюсь тебе нравится 💕
        </p>
      </footer>
    </div>
  );
